...
<br />
In other words: The minimizer <span>$f^*$</span> lies in the finite-dimensional subspace 
<div>
$$ \notag
...
with <span>$\mathscr{V}_{\text{constr}} = \mathrm{span}\{g_1,\ldots,g_m\}$</span>, to obtain a representation of the form
<div>
$$ \notag
